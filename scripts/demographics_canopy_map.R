...
tract_demo_canopy_base <- make_base_groups(demo_tract, canopy_tract, '../archive/tract_demo_canopy_base.html')
tract_demo_canopy_overlay <- make_overlay_groups(demo_tract, canopy_tract, '../archive/tract_demo_canopy_overlay.html')
