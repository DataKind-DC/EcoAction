...
# Create `data/rds/plantable_mpoly.rds` and `data/rds/plantable_and_open_mpoly.rds`
...
# 4. Remove canopy polygon from plantable_mpoly to get `plantable_and_open_mpoly`
...
plantable_and_open_mpoly <- sf::st_difference(plantable_mpoly, canopy_mpoly)
saveRDS(plantable_and_open_mpoly, "data/rds/plantable_and_open_mpoly.rds")

# Run this line at your own risk. It took like 30 min on my machine and created
#   a 232 MB html file
# quick_map(plantable_and_open_mpoly, "plantable_and_open")
